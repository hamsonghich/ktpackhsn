...
@Component({
  ...
  templateUrl: './content-thungnhuadanpla.component.html',
...
export class ContentThungnhuadanplaComponent implements OnInit {
  ...
  public getAllCustomer(): any{
    this.firebaseService.readFunctionalityList('/thungnhuadanpla').subscribe((res: any) => {
      // console.log(res);
  ...
  public updateCustomer(rowData: any, link: string): any{ // rowData chinh la du lieu cua tung hang trong bang
    const dialogRef = this.dialog.open(FormThungnhuadanplaComponent, {
      height:  '600px', width: '700px'
    });
    // hien thi diglog cho khi nhan vao edit (nhung chua co data)
    dialogRef.componentInstance.isEdit = true;
    // tslint:disable-next-line:max-line-length
    dialogRef.componentInstance.formDataThungnhuadanpla = rowData; // gan du lieu  formData cua createCustomer  =  voi rowData (rowData la data cua tung hang)
  ...
  public deleteDataCustomer(rowdata: any): any{
    ...
    this.firebaseService.deleteFunctionality(rowdata, '/thungnhuadanpla');
  }
